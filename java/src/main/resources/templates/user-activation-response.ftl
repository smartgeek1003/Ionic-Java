                        ...
                        <tr>
                          <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
                            <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
							  ...
							  <#if !error>
								<h4 class="h4"><font color="green">${message}</font></h4>
							 </#if>
                              ...
                              <tbody>
                                <tr align="center">
                                  <td align="center" valign="middle" style="border-collapse:collapse;">
                                    <#if error>
										<h4 class="h4"><font color="red">${message}</font></h4>
									<#else>
										<#if isProd>
											<a class="buttonText" href="${prodHost}/auth/login" target="_blank" style="color: #4A90E2;text-decoration: none;font-weight: normal;display: block;border: 2px solid #585858;padding: 10px 80px;font-family: Arial;">Login Here</a><br/>
										<#else>
											<a class="buttonText" href="${uiHost}/auth/login" target="_blank" style="color: #4A90E2;text-decoration: none;font-weight: normal;display: block;border: 2px solid #585858;padding: 10px 80px;font-family: Arial;">Login Here</a><br/>
										</#if>
