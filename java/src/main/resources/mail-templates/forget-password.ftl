                        ...
                        <tr>
                          <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
                            <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                              <h1 class="h1" style="color:#202020;display:block;font-family:Arial;font-size:24px;font-weight:bold;line-height:100%;margin-top:20px;margin-right:0;margin-bottom:20px;margin-left:0;text-align:center;">Hi ${username}, Reset Your Password</h1>
                              ...
                              <tbody>
                                <tr align="center">
                                  <td align="center" valign="middle" style="border-collapse:collapse;">
                                    <#if isProd>
                                    	<a class="buttonText" href="${prodHost}/auth/reset-password?token=${token}" target="_blank" style="color: #4A90E2;text-decoration: none;font-weight: normal;display: block;border: 2px solid #585858;padding: 10px 80px;font-family: Arial;">Reset Here</a><br/>
                                    <#else>
                                    	<a class="buttonText" href="${uiHost}/auth/reset-password?token=${token}" target="_blank" style="color: #4A90E2;text-decoration: none;font-weight: normal;display: block;border: 2px solid #585858;padding: 10px 80px;font-family: Arial;">Reset Here</a><br/>
                                    </#if>
                                    <small>link will be expire after 2 hrs (${expireAt?datetime})</small>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                  ...
                  <tr>
                    <td valign="top" class="footerContent" style="padding-left:0;border-collapse:collapse;background-color:#fafafa;">
                      <div style="text-align:center;color:#c9c9c9;font-family:Arial;font-size:11px;line-height:150%;">
                        <p style="text-align:left;margin:0;margin-top:2px;">SmartIot | Indore, India, 11201 | Copyright © 2019 | All rights reserved</p>
                      </div>
                      <!-- // End Module: Standard Footer \\ -->
                    </td>
                  </tr>
